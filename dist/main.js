...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _display_comment_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./display-comment.js */ \"./src/modules/display-comment.js\");\n\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (() => {\n  document.querySelector('body').addEventListener('click', (e) => {\n    if (e.target.id === 'submit-btn') {\n      document.querySelector('#comments-form').addEventListener('submit', (event) => {\n        event.preventDefault();\n        const id = document.querySelector('.card-popup').id[5];\n        const username = document.getElementById('user-name').value;\n        const comment = document.getElementById('user-comment').value;\n        if (username !== '') {\n          (0,_display_comment_js__WEBPACK_IMPORTED_MODULE_0__.addComment)(id, username, comment);\n          setTimeout(() => {\n            document.querySelector('.comments').remove();\n            (0,_display_comment_js__WEBPACK_IMPORTED_MODULE_0__.getComment)(event.target.parentElement.id[8]);\n          },\n          1000);\n        }\n      });\n    }\n  });\n});\n\n\n//# sourceURL=webpack://javascript-capstone-group-project/./src/modules/newComment.js?");
